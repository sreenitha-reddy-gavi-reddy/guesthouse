...
const EditForm = () =>{
    ...
    console.log(id);
    useEffect(()=>{
        axios.get('http://20.115.68.51:5000/api/get-single-user/'+id).then((res)=>{console.log(res.data.response)
    ...
    const handlesubmit=(e)=>{
        e.preventDefault();
        axios.put('http://20.115.68.51:5000/api/update-user/'+id, {formdata}).then((res)=>{alert(res.data.msg)})
        window.location.replace(
            "http://20.115.68.51:3000/orderlist"
           );
    }
